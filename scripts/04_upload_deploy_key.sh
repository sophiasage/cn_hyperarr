...
curl -s -u 'sophiasage' https://api.github.com/repos/sophiasage/cn_hyperarr/keys -d "{\"title\":\"Key for deploying documentation to GitHub pages\",\"key\":\"${filecontents}\", \"read_only\":\"false\"}" >> install.log
