# -*- coding: utf-8 -*-
#
# cn_hyperarr documentation build configuration file,
...
project = u"Congruence Normality for Hyperplane Arrangements"
copyright = u"2017, Sophia Elia"
package_name = "cn_hyperarr"
package_folder = "../../cn_hyperarr"
authors = u"Sophia Elia"
...
if (os.environ.get('SAGE_DOC_MATHJAX', 'no') != 'no'
    ...
    sage_path = os.path.abspath(os.path.join(SAGE_SRC, '..'))
    mathjax_relative = os.path.join('local','share','mathjax')

    # It would be really nice if sphinx would copy the entire mathjax directory,
    # (so we could have a _static/mathjax directory), rather than the contents of the directory

    mathjax_static = os.path.join(sage_path, mathjax_relative)
